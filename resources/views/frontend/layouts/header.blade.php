...
<style>
    .logo-container {
        width: 100%; /* Mulai dengan 100% untuk perangkat kecil */
        max-width: 200px; /* Batasi ukuran maksimum logo pada perangkat besar */
    ...
    @media (max-width: 768px) {
        .logo-container {
            max-width: 150px; /* Kurangi ukuran pada perangkat dengan lebar layar <= 768px */
        }
    }

    @media (max-width: 480px) {
        .logo-container {
            max-width: 120px; /* Kurangi ukuran lebih lanjut untuk layar yang lebih kecil */
        }
    }
    </style>
