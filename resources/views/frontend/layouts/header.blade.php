                ...
                <div class="col-lg-2 col-md-3 col-12">
                    <div class="right-bar">
                        ...
                        <div class="sinlge-bar shopping">
                            ...
                            @endforeach
                            @endif
                            <a href="{{route('wishlist')}}" class="single-icon"><i class="fa fa-heart"></i> <span
                                ...
                                <div class="bottom">
                                    <div class="total">
                                        ...
                                        <span class="total-amount">Rp.
                                            {{number_format(Helper::totalWishlistPrice(),2)}}</span>
                                    </div>
                                ...
                                <div class="navbar-collapse">
                                    <div class="nav-inner">
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li class="{{Request::path()=='afiliate' ? 'active' : ''}}"><a
                                                    href="{{route('afiliate')}}">Afiliate</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
...
<style>
    .logo-container {
        width: 100%;
        /* Mulai dengan 100% untuk perangkat kecil */
        max-width: 200px;
        /* Batasi ukuran maksimum logo pada perangkat besar */
        background: rgb(2, 16, 100);
        background: radial-gradient(circle, rgba(2, 16, 100, 1) 0%, rgba(0, 0, 0, 1) 47%, rgba(31, 6, 161, 1) 100%);
    ...
    @media (max-width: 768px) {
        .logo-container {
            max-width: 150px;
            /* Kurangi ukuran pada perangkat dengan lebar layar <= 768px */
        }
    }
    ...
    @media (max-width: 480px) {
        .logo-container {
            max-width: 120px;
            /* Kurangi ukuran lebih lanjut untuk layar yang lebih kecil */
        }
    }
</style>