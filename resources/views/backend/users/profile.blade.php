        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <div class="image">
                        @if($profile->photo)
                        <img class="card-img-top img-fluid roundend-circle mt-4 profile-image" style="border-radius:50%;height:80px;width:80px;margin:auto;" src="{{$profile->photo}}" alt="profile picture">
                        @else
                        <img class="card-img-top img-fluid roundend-circle mt-4 profile-image" style="border-radius:50%;height:80px;width:80px;margin:auto;" src="{{asset('backend/img/avatar.png')}}" alt="profile picture">
                        @endif
                    </div>
...
<style>
    ...
    .profile-image {
        transition: transform 0.4s ease; /* Efek transisi */
    }
    .profile-image:hover {
        transform: scale(3.5); /* Membesarkan gambar saat hover menjadi 4 kali lebih besar */
    }
    i{
        font-size: 14px;
        padding-right:8px;
