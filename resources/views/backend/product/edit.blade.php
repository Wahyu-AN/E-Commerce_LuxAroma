        ...
        <div class="form-group">
          ...
          <select name="size[]" class="form-control selectpicker"  multiple data-live-search="true">
              ...
              @foreach($items as $item)
                ...
                // dd($data);
                @endphp
              <option value="10"  @if( in_array( "10 ml",$data ) ) selected @endif>10 ml</option>
              <option value="25"  @if( in_array( "25 ml",$data ) ) selected @endif>25 ml</option>
              <option value="50"  @if( in_array( "50 ml",$data ) ) selected @endif>50 ml</option>
              <option value="100"  @if( in_array( "100 ml",$data ) ) selected @endif>100 ml</option>
              @endforeach
          </select>
        </div>
        <div class="form-group">
